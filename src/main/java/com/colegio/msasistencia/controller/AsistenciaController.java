...
public class AsistenciaController {
    ...
    public List<AsistenciaResponseDTO> obtenerPorEstudiante(@PathVariable Long id) {

        return asistenciaService.obtenerPorEstudiante(id);
    }

    @GetMapping("/curso/{id}")
    public List<AsistenciaResponseDTO> obtenerPorCurso(@PathVariable Long id) {

        return asistenciaService.obtenerPorCurso(id);
    }
